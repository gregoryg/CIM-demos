...
* Overview
  ...
  Bring up clusters with Cloudera Director.  Modify the Director template for your needs
  [[file:director/aws/cdsw/][here]].  The template includes configuration to use Hue Notebooks.
